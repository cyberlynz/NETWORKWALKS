...
The tool processed the file and produced a PDF hash beginning with **`$pdf# 🔵 W3-PM2 — Password Cracking with NetworkWalks Tools
...
**. The lab guide instructs the user to upload the locked PDF and obtain this PDF hash.
...
The lab specifically emphasizes copying the full hash beginning with **`$pdf# 🔵 W3-PM2 — Password Cracking with NetworkWalks Tools
...
**Evidence — Step 4:** The complete extracted hash is visible in the Step 3 screenshot above.
